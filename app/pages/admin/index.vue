   ...
   <div class="min-h-screen bg-[var(--bg-page)] text-[var(--text-main)] font-sans antialiased">
       ...
       <div class="flex justify-between items-center">
         <div>
          ...
          <div class="flex items-center gap-2">
            ...
            >
              <svg v-if="isDark" class="w-5 h-5 text-[var(--text-main)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="h-11 flex items-center bg-[var(--bg-card)] border-2 border-[var(--border)] px-5 rounded-2xl gap-2">
    ...
    <main class="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
       ...
       />
        <AdminOrderColumn
          title="Скасовані"
          accent-class="text-[var(--text-muted)]"
